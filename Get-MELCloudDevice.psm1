...
PROCESS {
    ...
    try {
       ...
       $MelDevice = $Info.value.Structure.Devices | select DeviceID,BuildingID, DeviceName, MacAddress, SerialNumber #| Format-Table
       $MelDevice     

       }

       $Global:MelDevice = $MelDevice
       $Global:MelDeviceID = $MelDevice.DeviceID
