...
PROCESS {
        ...
        if($Credential -eq $null) { $Credential = $global:melCredential}
        if($Credential -eq $null) { $Credential = Get-Credential }
write-debug 'check-credential'
        ...
        try {
            ...
            $Global:MelCredential = $Credential 
            $Global:MelContext = $obj
            $Global:MelCOntextKey = $obj.ContextKey           
